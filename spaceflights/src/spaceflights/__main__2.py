...
# Solution sent to Ivan returns stuff rather exiting when call main entry point. NEED TO READ UP ON WHETHER THIS IS A PROBLEM AND HOW DATBRICKS ENTRYPOINT WITH KWARGS WORKS.
